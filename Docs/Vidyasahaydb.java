//Step 0: Adding a Package
import java.sql.Connection;
import java.sql.DriverManager;
import java.sql.Statement;
import java.sql.ResultSet;

public class Vidyasahaydb {
	public static void main(String[] args)
	{
		try
		{
			...
			Connection con= DriverManager.getConnection("jdbc:postgresql://localhost:5432/vidyasahaydb","postgres","Paras01@");
			System.out.println("Connected successfully.");
			String query2="INSERT INTO dev.users (id, role_id, first_name, last_name, email, mobile, hashed_password, must_change_password, is_active, created_at, updated_at) VALUES ('47dcedee-f5d6-5a93-a9c6-1425aa435cf6', 'ce3dfb00-ad64-5a7f-8f36-37e331edf162', 'Bank1', 'Demo', 'bank1@vidyasahay.com', '9000000011', '$2a$10$wTP.bLmQZOmOco4sO9tnJeKH6cwExMXnxg87RUmz72vJaNR6WQBDW', False, True, '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n";
			String query ="BEGIN;\r\n"
...
+ "    id, bank_id, name, status, effective_from, effective_to,\r\n"
+ "    min_loan_amount, max_loan_amount, interest_type,\r\n"
+ "    minimum_rate, maximum_rate, disbursement_type,\r\n"
+ "    created_by, updated_by, created_at, updated_at\r\n"
+ ") VALUES\r\n"
+ "('309d7984-5ac0-5587-8eb5-86575a198f61', 'eacd169b-f66a-54a9-98d6-ebff13531bb5', 'Education Loan 1', 'ACTIVE', '2026-01-01', '2030-12-31', 50000.00, 600000.00, 'FLOATING', 7.5000, 11.5000, 'YEARLY', '47dcedee-f5d6-5a93-a9c6-1425aa435cf6', '47dcedee-f5d6-5a93-a9c6-1425aa435cf6', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('9fe875e8-b10a-5647-bf68-726451a45bb2', '55a648a4-b1f5-5820-af60-67b34f06d43f', 'Education Loan 2', 'ACTIVE', '2026-01-01', '2030-12-31', 50000.00, 700000.00, 'FLOATING', 7.5000, 11.5000, 'ONE_TIME', '8e750dbb-b277-5e98-94ec-98965e3b85ca', '8e750dbb-b277-5e98-94ec-98965e3b85ca', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('2b2020e7-0e57-5cc7-8c43-ecb93a8eee78', '76c9192d-3859-53d3-9dd9-cfee10df3a91', 'Education Loan 3', 'ACTIVE', '2026-01-01', '2030-12-31', 50000.00, 800000.00, 'FIXED', 7.5000, 11.5000, 'YEARLY', '6bc45c49-0ba3-5959-a46b-69ac19501d16', '6bc45c49-0ba3-5959-a46b-69ac19501d16', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('5b77f441-dd90-53ac-8f6f-abd39236138b', 'd896be7c-849a-5f10-ad96-76dbf502a717', 'Education Loan 4', 'INACTIVE', '2026-01-01', '2030-12-31', 50000.00, 900000.00, 'FLOATING', 7.5000, 11.5000, 'ONE_TIME', '955ef5b5-1ad2-55e8-8288-6d69ace5e415', '955ef5b5-1ad2-55e8-8288-6d69ace5e415', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('5d48af3d-1da6-5593-9c54-ca0ab0a95009', 'c976a81b-da15-5301-9f53-7297005fff1d', 'Education Loan 5', 'ACTIVE', '2026-01-01', '2030-12-31', 50000.00, 1000000.00, 'FIXED', 7.5000, 11.5000, 'YEARLY', 'c5f70aac-0c9c-5f71-a1d0-e97d79af2ad8', 'c5f70aac-0c9c-5f71-a1d0-e97d79af2ad8', '2026-09-17 10:00:00', '2026-09-17 10:00:00');"
					+ "\r\n"
...
+ "    id, name, scholarship_type, academic_year, start_date, end_date,\r\n"
...
+ "('ea7f320c-da1e-5735-8758-c0b61f2739d1', 'Government Scholarship 2', 'CATEGORY_BASED', '2026-27', '2026-06-01', '2027-03-31', 'ACTIVE', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('1c75aa66-3401-57b4-97a8-584869331315', 'Government Scholarship 3', 'MERIT_BASED', '2026-27', '2026-06-01', '2027-03-31', 'INACTIVE', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('85038174-bdf5-5450-a820-e318a4ad7ef0', 'Government Scholarship 4', 'CATEGORY_BASED', '2026-27', '2026-06-01', '2027-03-31', 'ACTIVE', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '1bfd80a7-b582-55cc-9ec6-eddfd256f103', '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
...
+"INSERT INTO scholarship_benefit_details (\r\n"
+ "    id, scholarship_scheme_id, scholarship_amount, amount_type,\r\n"
+ "    payment_frequency, total_scheme_budget, created_at, updated_at\r\n"
+ ") VALUES\r\n"
+ "('2dd90cbe-975f-514d-9c08-c2e950a1f695', 'b47bb1ec-d0d1-5e99-933a-37dd6bcf0a7e', 10000.00, 'FIXED_AMOUNT', 'ONE_TIME', 1000000.00, '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('b96b211f-2db7-5ef4-9229-9e95dae6f64d', 'ea7f320c-da1e-5735-8758-c0b61f2739d1', 10.00, 'PERCENTAGE_OF_FEES', 'MONTHLY', 2000000.00, '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('89a132d0-c3e1-5a2b-8d3c-49c16766e3ec', '1c75aa66-3401-57b4-97a8-584869331315', 30000.00, 'FIXED_AMOUNT', 'QUARTERLY', 3000000.00, '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('08c83bc5-168c-5e46-8f16-3ae286e1b16c', '85038174-bdf5-5450-a820-e318a4ad7ef0', 25.00, 'PERCENTAGE_OF_FEES', 'YEARLY', 4000000.00, '2026-09-17 10:00:00', '2026-09-17 10:00:00'),\r\n"
+ "('bf22974d-5ddf-5b0d-bdf5-7b73ddd5f934', '20bec9a0-5218-557f-bef7-57b8ce563125', 50000.00, 'FIXED_AMOUNT', 'YEARLY', 5000000.00, '2026-09-17 10:00:00', '2026-09-17 10:00:00');"
			...
			System.out.println("Created Statement Succesfully.");
			
			//Step 4: Execute SQL Query
			//Change query or query2 accordingly.
...
//			}
//			System.out.println("Executed SQL Query Successfully");
